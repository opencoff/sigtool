...
const file_internal_pb_key_proto_rawDesc = "" +
	"\n" +
	"\x15internal/pb/key.proto\"\x16\n" +
	"\x02sk\x12\x10\n" +
	"\x03esk\x18\x01 \x01(\fR\x03esk\"U\n" +
	"\x05argon\x12\x10\n" +
	"\x03mem\x18\x01 \x01(\rR\x03mem\x12\x12\n" +
	"\x04time\x18\x02 \x01(\rR\x04time\x12\x12\n" +
	"\x04proc\x18\x03 \x01(\rR\x04proc\x12\x12\n" +
	"\x04salt\x18\x04 \x01(\fR\x04salt\"\x14\n" +
	"\x02pk\x12\x0e\n" +
